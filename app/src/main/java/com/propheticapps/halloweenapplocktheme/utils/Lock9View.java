package com.propheticapps.halloweenapplocktheme.utils;
...
public class Lock9View extends ViewGroup {
    ...
    public class NodeView extends View {
        ...
        public NodeView(Context context, int num) {
            ...
            MyPreferenceActivity pref = new MyPreferenceActivity(context.getApplicationContext());
            Log.i("imageposition...", "...." + pref.getGifImage());

            imageRes = pref.getGifImage();
            ImageAdapter imageAdapter = new ImageAdapter();
            mThumbIds = imageAdapter.mThumbIds;
            ...
            if (imageRes == 0)
            {
                ...
                highLighted = false;
                if (nodeSrc == null) {
                    setBackgroundResource(mThumbIds[imageRes]);
                } else {
        ...
        public void setHighLighted(boolean highLighted) {
            ...
            Log.i("setHighLighted....()","...");
            if (highLighted) {
                if (nodeOnSrc == null) {

                    setBackgroundResource(R.mipmap.staticc);
                } else {
